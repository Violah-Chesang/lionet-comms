        ...
        <div className="header-row">
          <div className="header-col">
            <div className="header-col-content">
              <span className="services-content-header">
                Evolutionizing connection and communication
              </span>
              <p>
        ...
        <div className="rows">
          ...
          <div className="services-row">
            <div className="services-col">
              ...
              <button className="service-btn" onClick={() => navigate("fibre")}>
                Read more
              </button>
            </div>
            ...
            <div className="services-col">
              ...
              <button
                ...
                onClick={() => navigate("internet-connectivity")}
              >
                Read more
              </button>
            </div>
            ...
            <div className="services-col">
              ...
              <button className="service-btn" onClick={() => navigate("cctv")}>
                Read more
              </button>
            </div>
          </div>
          ...
          <div className="services-row">
            <div className="services-col">
              ...
              <div className="services-col-desc">
                <p>
                  We Help Businesses In Maintaining Their IT Infrastructure So
                  That They Can Worry Less And Concentrate On Their Core
                  Businesses. We Analyze Your System To Give Best Advise
                  Possible For Optimal Service.
                </p>
              </div>
              <button
                className="service-btn"
            ...
            <div className="services-col">
              ...
              <div className="services-col-desc">
                <p>
                  ...
                  Out Standards To Cater For Your Data, Voice, And Video
              ...
              <button
                className="service-btn"
                onClick={() => navigate("structured-cabling")}
              >
                Read more
              </button>
            </div>
            ...
            <div className="services-col">
              ...
              <button className="service-btn" onClick={() => navigate('cloud-services')}>Read more</button>
            </div>
          </div>
        </div>
      </div>
